...
var solutionName = "LoaderView";
var repoName = "martijn00/LoaderViewXamarin";
    ...
    .Does(() => 
{
    ...
    foreach(var file in files)
    {
        ...
        var arguments = new ProcessArgumentBuilder()
            ...
            .AppendSwitchQuoted("-n", "LoaderViewXamarin")
            .AppendSwitchQuoted("-d", "Library that enables TextView of ImageView to show loading animation while waiting for the text and image get loaded")
